...
public final class Utils {
    ...
    /**
     * @param words the list of words (Description)
     * @param word the filter word
     * @return 1 if true, 0 if false
     */
    public static boolean getWord(final String words, final String word) {
        Pattern pattern = Pattern.compile("[^A-Za-z0-9]" + word
